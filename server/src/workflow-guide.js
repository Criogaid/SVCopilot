  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        note: "In practice pass apply.arguments from step 2 with action dry_run.",
        acceptable: ["status dry_run"],
      },
      {
        n: 4,
        tool: "sv_patch_notes",
        purpose: "Commit the identical arguments with action commit.",
        arguments: {
          contextId: EXAMPLE.contextId,
          patches: [
            { note: 0, expected: { lyrics: "" }, set: { lyrics: "ひ" } },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        note: "In practice submit apply.arguments from step 2 with action dry_run.",
        acceptable: ["status dry_run"],
      },
      {
        n: 4,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        note: "In practice submit apply.arguments from step 3 with action dry_run.",
        acceptable: ["status dry_run"],
      },
      {
        n: 5,
...
const DEFAULT_WORKFLOW = [
  ...
  "hardened editor action:\"dry_run\" and read plannedDiff",
