      ...
      curves: [
        {
          ...
          mode: "replace",
          range: {
            from: { anchor: { noteId: "c_x:t:0:r:0:n:0", position: "onset" } },
            to: { anchor: { noteId: "c_x:t:0:r:0:n:0", position: "end" } },
          },
          points: [{ anchor: { noteId: "c_x:t:0:r:0:n:0", position: "center" }, value: 1 }],
        },
      ],
    },
      ...
      curves: [
        {
          parameter: "tension",
          mode: "replace",
          range: { from: { anchor: { noteId: "c_x:t:0:r:0:n:0" } }, to: { blick: 10 } },
          points: [{ blick: 0, value: 1 }],
        },
      ],
    },
      ...
      curves: [
        {
          ...
          mode: "replace",
          range: {
            from: { anchor: { noteId: "c_x:t:0:r:0:n:0", position: "onset", bogus: 1 } },
            to: { blick: 10 },
          },
          points: [{ blick: 0, value: 1 }],
        },
      ...
      curves: [
        {
          ...
          mode: "replace",
          range: {
            from: { anchor: { noteId: "c_x:t:0:r:0:n:0", position: "ratio", ratio: 9 } },
            to: { blick: 10 },
          },
          points: [{ blick: 0, value: 1 }],
        },
